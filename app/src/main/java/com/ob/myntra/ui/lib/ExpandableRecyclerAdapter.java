 ...
 *
 *   // http://stackoverflow.com/questions/34520415/how-to-smoothly-scroll-to-clicked-item-to-top-of-recyclerview
 */
...
public abstract class ExpandableRecyclerAdapter<T extends ExpandableRecyclerAdapter.ListItem> extends RecyclerView.Adapter<ExpandableRecyclerAdapter.ViewHolder> {
    ...
    private LinearLayoutManager mRecyleViewLayoutManager;
    ...
    public class HeaderViewHolder extends ViewHolder {
        ...
        protected void handleClick() {
          ...
          /*  int offset = getLayoutPosition() - mRecyleViewLayoutManager.findFirstVisibleItemPosition();
            if (mRecyleViewLayoutManager.findFirstVisibleItemPosition() > 0) {
                offset -= 1;
            }
            mRecyleViewLayoutManager.scrollToPositionWithOffset(getLayoutPosition(), offset);*/
        }
    ...
    public void setRecyleViewLayoutManager(LinearLayoutManager recyleViewLayoutManager){
        mRecyleViewLayoutManager = recyleViewLayoutManager;
    }
    ...
    public static void closeArrow(View view) {
        ...
        ImageView imageView = (ImageView) view;
        imageView.setImageResource(R.drawable.ic_add_black24dp);
    }
