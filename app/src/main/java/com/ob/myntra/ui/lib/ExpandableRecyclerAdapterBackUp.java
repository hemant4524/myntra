...
public abstract class ExpandableRecyclerAdapterBackUp<T extends ExpandableRecyclerAdapterBackUp.ListItem> extends RecyclerView.Adapter<ExpandableRecyclerAdapterBackUp.ViewHolder> {
    ...
    public ExpandableRecyclerAdapterBackUp(Context context) {
        mContext = context;
    }
