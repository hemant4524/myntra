package com.ob.myntra.ui.lib.search.db;
...
public class HistoryContract {
    ...
    private static String initAuthority() {
        String authority = "com.ob.myntra.productsearchview.defaultsearchhistorydatabase";

        try {
            ClassLoader clazzLoader = HistoryContract.class.getClassLoader();
            Class<?> clazz = clazzLoader.loadClass("com.ob.myntra.ui.MsvAuthority");
