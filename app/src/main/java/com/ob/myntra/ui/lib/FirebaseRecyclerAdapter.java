...
public abstract class FirebaseRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    public static final String TAG = FirebaseRecyclerAdapter.class.getSimpleName();
    ...
    public FirebaseRecyclerAdapter(Query query, Class<T> itemClass,
      ...
      //  query.addChildEventListener(mListener);
        query.addValueEventListener(valueEvent);
    }
    ...
    private ValueEventListener valueEvent = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            for (DataSnapshot catDataSnapshot: dataSnapshot.getChildren()){
                ...
                catDataSnapshot.getValue(Category.class);
                array.add(category);

            }
            Log.d(TAG, "getData: "+array.size());
        }
